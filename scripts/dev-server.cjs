...
http.createServer(async(req,res)=>{
 ...
 try {
  ...
  const allowed=['index.html','styles.css','app.js','gallery-model.js','gallery-data.js','hero-slider.js','harita/index.html','harita/map.css','harita/photo-map.js','harita/photo-layer.js','harita/city-photos.js','harita/map-photos.js'];
